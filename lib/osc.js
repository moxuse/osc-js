(function (global, factory) {
  ...
  var AtomicChar = function (_Atomic) {
    _inherits(AtomicChar, _Atomic);
    var _super = _createSuper(AtomicChar);
    function AtomicChar(value) {
      _classCallCheck(this, AtomicChar);
      if (isUndefined(value)) {
        throw new Error('Failed to construct AtomicChar');
      }
      return _super.call(this, value);
    }
    _createClass(AtomicChar, [{
      key: "pack",
      value: function pack() {
        if (isUndefined(this.value)) {
          throw new Error('OSC AtomicChar can not be encoded with empty value');
        }
        return _get(_getPrototypeOf(AtomicChar.prototype), "pack", this).call(this, 'setInt32', 4);
      }
    }, {
      key: "unpack",
      value: function unpack(dataView) {
        var initialOffset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        return _get(_getPrototypeOf(AtomicChar.prototype), "unpack", this).call(this, dataView, 'getInt32', 4, initialOffset);
      }
    }]);
    return AtomicChar;
  }(Atomic);
      ...
      value: function pack() {
        ...
        if (this.args.length > 0) {
          ...
          this.args.forEach(function (value, index) {
            ...
            } else if (type === '[' || type === ']') ; else if (type === 'h') {
